...
public class FormatUtil {
    ...
    public static String listOfTChannels(List<TextChannel> list, String query) {
        StringBuilder out = new StringBuilder(" with multiple text channels\"" + query + "\"matched:");
    ...
    public static String listOfVChannels(List<VoiceChannel> list, String query) {
        StringBuilder outBuilder = new StringBuilder(" with multiple voice channels\"" + query + "\"matched:");
        for (int i = 0; i < 6 && i < list.size(); i++)
    ...
    public static String listOfRoles(List<Role> list, String query) {
        StringBuilder outBuilder = new StringBuilder(" with multiple text channels \"" + query + "\"matched:");
        for (int i = 0; i < 6 && i < list.size(); i++)
