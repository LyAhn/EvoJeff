...
public String request() {
         if (method == null || method.isEmpty()) throw new NullPointerException("Method not set.");
         if (targetAddress == null || targetAddress.isEmpty()) throw new NullPointerException("URL not set.");
         ...
         try {
             ...
             throw new NullPointerException("Invalid method name: " + e.getLocalizedMessage());
         } catch (IOException e) {
             StringBuilder sb = new StringBuilder();
             try {
                 if (connection.getInputStream() != null) {
